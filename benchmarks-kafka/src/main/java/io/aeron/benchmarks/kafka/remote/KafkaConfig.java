 ...
 */
package io.aeron.benchmarks.kafka.remote;
...
import static io.aeron.benchmarks.kafka.remote.PartitionSelection.byName;

final class KafkaConfig
{
    public static final String PARTITION_SELECTION_PROP_NAME = "io.aeron.benchmarks.kafka.remote.partition";
    public static final String PRODUCER_MAX_IN_FLIGHT_MESSAGES_PROP_NAME =
        "io.aeron.benchmarks.kafka.remote.producer.max.in.flight.messages";
