...
import static io.aeron.benchmarks.kafka.PartitionSelection.byName;

final class KafkaConfig
{
    public static final String PARTITION_SELECTION_PROP_NAME = "io.aeron.benchmarks.kafka.partition";
    public static final String PRODUCER_MAX_IN_FLIGHT_MESSAGES_PROP_NAME =
        "io.aeron.benchmarks.kafka.producer.max.in.flight.messages";
