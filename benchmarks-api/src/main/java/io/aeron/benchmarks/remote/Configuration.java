 ...
 */
package io.aeron.benchmarks.remote;
...
public final class Configuration
{
     ...
     */
    public static final String WARMUP_ITERATIONS_PROP_NAME = "io.aeron.benchmarks.remote.warmup.iterations";
     ...
     * @see #iterations()
     */
    public static final String ITERATIONS_PROP_NAME = "io.aeron.benchmarks.remote.iterations";
     ...
     * @see #messageRate()
     */
    public static final String MESSAGE_RATE_PROP_NAME = "io.aeron.benchmarks.remote.message.rate";
     ...
     */
    public static final String WARMUP_MESSAGE_RATE_PROP_NAME = "io.aeron.benchmarks.remote.warmup.message.rate";
     ...
     * @see #batchSize()
     */
    public static final String BATCH_SIZE_PROP_NAME = "io.aeron.benchmarks.remote.batch.size";
     ...
     * @see #messageLength()
     */
    public static final String MESSAGE_LENGTH_PROP_NAME = "io.aeron.benchmarks.remote.message.length";
     ...
     * @see #idleStrategy()
     */
    public static final String IDLE_STRATEGY_PROP_NAME = "io.aeron.benchmarks.remote.idle.strategy";
     ...
     */
    public static final String MESSAGE_TRANSCEIVER_PROP_NAME = "io.aeron.benchmarks.remote.message.transceiver";
     ...
     */
    public static final String OUTPUT_DIRECTORY_PROP_NAME = "io.aeron.benchmarks.remote.output.directory";

    /**
     * Name of the required system property to configure the output file name prefix.
     */
    public static final String OUTPUT_FILE_NAME_PROP_NAME = "io.aeron.benchmarks.remote.output.file";

    /**
     * Name of property to indicate tracking of latency history
     */
    public static final String TRACK_HISTORY_PROP_NAME = "io.aeron.benchmarks.remote.track.history";

    /**
     * Name of property to enable or disable progress reporting. Defaults to {@code true}.
     */
    public static final String REPORT_PROGRESS_PROP_NAME = "io.aeron.benchmarks.remote.report.progress";

    /**
     * Name of property to define output time unit. Default value: microseconds.
     */
    public static final String OUTPUT_TIME_UNIT_PROPERTY_NAME = "io.aeron.benchmarks.remote.output.time.unit";
