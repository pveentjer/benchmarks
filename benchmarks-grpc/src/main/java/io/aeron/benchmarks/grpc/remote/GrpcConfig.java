...
{
    public static final String CLIENT_HOST_PROP_NAME = "io.aeron.benchmarks.grpc.remote.client.host";
    public static final String CLIENT_PORT_PROP_NAME = "io.aeron.benchmarks.grpc.remote.client.port";
    public static final String SERVER_HOST_PROP_NAME = "io.aeron.benchmarks.grpc.remote.server.host";
    public static final String SERVER_PORT_PROP_NAME = "io.aeron.benchmarks.grpc.remote.server.port";
    public static final String TLS_PROP_NAME = "io.aeron.benchmarks.grpc.remote.tls";
    public static final String CERTIFICATES_DIR_PROP_NAME = "io.aeron.benchmarks.grpc.remote.certificates";
