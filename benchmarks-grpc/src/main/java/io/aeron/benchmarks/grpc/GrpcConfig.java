...
{
    public static final String CLIENT_HOST_PROP_NAME = "io.aeron.benchmarks.grpc.client.host";
    public static final String CLIENT_PORT_PROP_NAME = "io.aeron.benchmarks.grpc.client.port";
    public static final String SERVER_HOST_PROP_NAME = "io.aeron.benchmarks.grpc.server.host";
    public static final String SERVER_PORT_PROP_NAME = "io.aeron.benchmarks.grpc.server.port";
    public static final String TLS_PROP_NAME = "io.aeron.benchmarks.grpc.tls";
    public static final String CERTIFICATES_DIR_PROP_NAME = "io.aeron.benchmarks.grpc.certificates";
