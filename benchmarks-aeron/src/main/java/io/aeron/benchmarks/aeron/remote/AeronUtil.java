...
import static io.aeron.benchmarks.aeron.remote.ArchivingMediaDriver.launchArchiveWithStandaloneDriver;
...
final class AeronUtil
{
    ...
    static final String RECEIVER_INDEX_PROP_NAME = "io.aeron.benchmarks.aeron.remote.receiver.index";
    static final String NUMBER_OF_RECEIVERS_PROP_NAME =
        "io.aeron.benchmarks.aeron.remote.receiver.count";
    static final String CLUSTER_SERVICE_PROP_NAME = "io.aeron.benchmarks.aeron.remote.cluster.service";
    static final String SNAPSHOT_SIZE_PROP_NAME = "io.aeron.benchmarks.aeron.remote.cluster.snapshot.size";
    static final long DEFAULT_SNAPSHOT_SIZE = 0;
    static final String DESTINATION_CHANNEL_PROP_NAME =
        "io.aeron.benchmarks.aeron.remote.destination.channel";
    static final String DESTINATION_STREAM_PROP_NAME =
        "io.aeron.benchmarks.aeron.remote.destination.stream";
    static final String SOURCE_CHANNEL_PROP_NAME = "io.aeron.benchmarks.aeron.remote.source.channel";
    static final String SOURCE_STREAM_PROP_NAME = "io.aeron.benchmarks.aeron.remote.source.stream";
    static final String RECORD_CHANNEL_PROP_NAME = "io.aeron.benchmarks.aeron.remote.record.channel";
    static final String RECORD_STREAM_PROP_NAME = "io.aeron.benchmarks.aeron.remote.record.stream";
    static final String REPLAY_CHANNEL_PROP_NAME = "io.aeron.benchmarks.aeron.remote.replay.channel";
    static final String REPLAY_STREAM_PROP_NAME = "io.aeron.benchmarks.aeron.remote.replay.stream";
    static final String EMBEDDED_MEDIA_DRIVER_PROP_NAME =
        "io.aeron.benchmarks.aeron.remote.embedded.media.driver";
    static final String FRAGMENT_LIMIT_PROP_NAME = "io.aeron.benchmarks.aeron.remote.fragment.limit";
    static final String IDLE_STRATEGY_PROP_NAME = "io.aeron.benchmarks.aeron.remote.idle.strategy";
    static final String CONNECTION_TIMEOUT_PROP_NAME = "io.aeron.benchmarks.aeron.remote.connection.timeout";
    ...
    static final String FAILOVER_CONTROL_SERVER_HOSTNAME_PROP_NAME =
        "io.aeron.benchmarks.aeron.remote.cluster.failover.control.server.hostname";
    static final String FAILOVER_CONTROL_SERVER_PORT_PROP_NAME =
        "io.aeron.benchmarks.aeron.remote.cluster.failover.control.server.port";
    static final String FAILOVER_CONTROL_ENDPOINTS_PROP_NAME =
        "io.aeron.benchmarks.aeron.remote.cluster.failover.control.endpoints";
    static final String FAILOVER_DELAY_PROP_NAME =
        "io.aeron.benchmarks.aeron.remote.cluster.failover.delay";
